...
#' @export
plot_long_alluvial_demo <- function(.data, ...) {
  UseMethod("plot_long_alluvial_demo")
}

#' Plotting function to generate Alluvial plots from \code{longZightAlluv} objects
#' @rdname plot_long_alluvial_demo
#' @method plot_long_alluvial_demo longZightAlluv
#' @export
plot_long_alluvial_demo.longZightAlluv <- function(.data, fillfunc = ggplot2::scale_fill_discrete(), highlight = NULL, focus = NULL) {
...
#' @rdname plot_long_alluvial_demo
#' @method plot_long_alluvial_demo longZightLasagna
#' @export
plot_long_alluvial_demo.longZightLasagna <- function(.data, alluvium = FALSE, fillfunc = ggplot2::scale_fill_discrete(), highlight = NULL, ...) {
  if (!is.null(highlight)) {
